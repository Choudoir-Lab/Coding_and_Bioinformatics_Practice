...
parser.add_argument('-s', '--sep', help="Provide comma-separated list of names that group the different spreadsheets", nargs=1, default=None, required=True)
...
with pd.ExcelWriter("Ecoplate_Average_Well_Color_Development.xlsx") as writer_2:
    if "," in separator:
